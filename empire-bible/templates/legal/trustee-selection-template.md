...
**Trustee Role**: [ ] Administrative [ ] Investment [ ] Distribution [ ] Trust Protector
...
### Administrative Trustee Qualifications
...
**Qualification Score**: _______________/10

---

### Investment Trustee Qualifications
...
- [ ] Trust Experience: [ ] Yes [ ] No

**Qualification Score**: _______________/10

---

### Distribution Trustee Qualifications

**Required Qualifications**:
- [ ] Family member or trusted advisor
- [ ] Understands HEMS standard
- [ ] Can make objective decisions
- [ ] Acts in beneficiaries' best interests
- [ ] Available for distribution decisions
- [ ] Good judgment

**Candidate Qualifications**:
- [ ] Relationship: _______________
- [ ] HEMS Understanding: [ ] Strong [ ] Moderate [ ] Weak
- [ ] Objectivity: [ ] Strong [ ] Moderate [ ] Weak
...
### Trust Protector Qualifications

**Required Qualifications**:
- [ ] Family member or trusted advisor
- [ ] Understands trust objectives
- [ ] Can exercise powers responsibly
- [ ] Acts in trust's best interests
- [ ] Available when needed
- [ ] Good judgment and integrity

**Candidate Qualifications**:
- [ ] Relationship: _______________
- [ ] Trust Understanding: [ ] Strong [ ] Moderate [ ] Weak
- [ ] Responsibility: [ ] Strong [ ] Moderate [ ] Weak
- [ ] Availability: [ ] Excellent [ ] Good [ ] Fair [ ] Poor
- [ ] Judgment: [ ] Excellent [ ] Good [ ] Fair [ ] Poor
...
- [ ] Years administering trusts: _______________
- [ ] Number of trusts: _______________
- [ ] Track record: [ ] Excellent [ ] Good [ ] Fair [ ] Poor
- [ ] Client retention: _______________%

**Investment Trustee**:
- [ ] Years managing investments: _______________
- [ ] Assets under management: $_______________
- [ ] Performance track record: [ ] Excellent [ ] Good [ ] Fair [ ] Poor
- [ ] Client retention: _______________%

**Distribution Trustee**:
- [ ] Experience with distributions: [ ] Yes [ ] No
- [ ] Experience with HEMS: [ ] Yes [ ] No
- [ ] Family relationship experience: [ ] Yes [ ] No

**Trust Protector**:
- [ ] Experience as Trust Protector: [ ] Yes [ ] No
- [ ] Experience with trust administration: [ ] Yes [ ] No
- [ ] Family governance experience: [ ] Yes [ ] No
...
**Service Quality Score**: _______________/10

---

## Section 4: Alignment with Trust Objectives

### Understanding of Objectives

- [ ] **Understands 365-Year Vision**: 
  - [ ] Strong [ ] Moderate [ ] Weak

- [ ] **Understands Family Values**: 
  - [ ] Strong [ ] Moderate [ ] Weak

- [ ] **Understands Trust Goals**: 
  - [ ] Strong [ ] Moderate [ ] Weak
...
**Alignment Score**: _______________/10
...
**Reference Score**: _______________/10
...
- **9.0-10.0**: Strongly Recommend - Excellent choice
- **7.0-8.9**: Recommend - Good choice
- **5.0-6.9**: Conditional - Proceed with caution
- **3.0-4.9**: Not Recommend - Significant concerns
- **0.0-2.9**: Strongly Not Recommend - Do not proceed

**Recommendation**: [ ] Strongly Recommend [ ] Recommend [ ] Conditional [ ] Not Recommend [ ] Strongly Not Recommend
...
- [ ] **Succession Plan Documented**: [ ] Yes [ ] No
- [ ] **Succession Triggers Defined**: 
  - [ ] Death
  - [ ] Incapacitation
  - [ ] Resignation
  - [ ] Removal

- [ ] **Succession Process Defined**: 
...
**Next Steps**: 
1. Complete evaluation for all trustee candidates
