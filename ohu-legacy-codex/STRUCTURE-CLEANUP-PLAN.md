# Legacy Codex Structure Cleanup Plan
...
- **volume-ii-legal** (2 files) vs **volume-ii-legal-fiduciary** (12 files) â†’ Keep volume-ii-legal-fiduciary, remove volume-ii-legal
- **volume-iii-revenue** (6 files) vs **volume-iii-revenue-business-systems** (complete) â†’ Keep volume-iii-revenue-business-systems, remove volume-iii-revenue
