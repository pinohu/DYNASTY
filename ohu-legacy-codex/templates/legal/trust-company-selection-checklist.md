...
- [ ] **Manager Experience**: _______________ years
...
- [ ] **Fee Structure Provided**: [ ] Yes [ ] No
- [ ] **All Fees Disclosed**: [ ] Yes [ ] No
- [ ] **Hidden Fees**: [ ] None [ ] Some [ ] Many

### Fee Amounts

- [ ] **Base Annual Fee**: $_______________
- [ ] **Asset-Based Fee**: _______________% (if applicable)
- [ ] **Transaction Fees**: $_______________ per transaction
- [ ] **Other Fees**: $_______________

**Total Estimated Annual Cost**: $_______________
...
- [ ] **Fee Justification**: 
  - [ ] Fees justified by service quality
  - [ ] Fees reasonable for services
  - [ ] Fees seem high
  - **Notes**: _______________

**Fee Score**: _______________/10
...
**Technology Score**: _______________/10
...
**Compliance Score**: _______________/10
...
- **Trust Size**: $_______________
- **Years as Client**: _______________
...
**Advisor Reference 1**: _______________
- **Type**: [ ] Attorney [ ] CPA [ ] Financial Advisor [ ] Other
- **Comments**: 
  _________________________________________________________________
  _________________________________________________________________

**Advisor Reference 2**: _______________
- **Type**: [ ] Attorney [ ] CPA [ ] Financial Advisor [ ] Other
- **Comments**: 
  _________________________________________________________________
  _________________________________________________________________
...
- **7.0-8.9**: Recommend - Good choice with minor concerns
- **5.0-6.9**: Conditional - Proceed with caution, address concerns
- **3.0-4.9**: Not Recommended - Significant concerns
- **0.0-2.9**: Strongly Not Recommended - Do not proceed
...
| Company | Experience | Financial | Service | Fees | Technology | Compliance | Total |
|---------|------------|-----------|---------|------|------------|------------|-------|
| Company 1 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 |
| Company 2 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 |
| Company 3 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 | ___/10 |

**Top Choice**: _______________
...
- [ ] Complete evaluation for all candidate companies
- [ ] Compare scores and recommendations
- [ ] Conduct final interviews with top 2-3 companies
...
**Next Steps**: 
1. Complete this checklist for each candidate company
2. Compare all evaluations
3. Select top choice
4. Negotiate terms
5. Execute agreement
