...
## Legacy Codex Master Cross-Reference Audit
...
Example: `[See Chapter 2.1]` â†’ Should point to Chapter 2, Section 1

### 2. Volume References
Format: `[See Volume X]` or `[See Volume X, Chapter Y]`
Example: `[See Volume II, Chapter 4]` â†’ Should point to Volume II, Chapter 4

### 3. Template References
Format: `[See Template: Name]` or `[See templates/name-template.md]`
Example: `[See Template: Decision Matrix]` â†’ Should point to template file

### 4. Checklist References
Format: `[See Checklist: Name]` or `[See checklists/name-checklist.md]`
Example: `[See Checklist: Investment Criteria]` â†’ Should point to checklist file

### 5. Appendix References
Format: `[See Appendix X]` or `[See appendices/name.md]`
Example: `[See Appendix A]` â†’ Should point to appendix file
